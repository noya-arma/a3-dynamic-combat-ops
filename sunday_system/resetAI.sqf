...
_unit = switch (_startID) do {
	case 1: {((units _playerGroup) select 0)};
	case 2: {((units _playerGroup) select 1)};
	case 3: {((units _playerGroup) select 2)};
	case 4: {((units _playerGroup) select 3)};
	case 5: {((units _playerGroup) select 4)};
	case 6: {((units _playerGroup) select 5)};
	case 7: {((units _playerGroup) select 6)};
	case 8: {((units _playerGroup) select 7)};
};
